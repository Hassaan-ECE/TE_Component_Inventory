...
export const THEME_STORAGE_KEY = "teComponentInventory.theme";
export const COLOR_ROWS_STORAGE_KEY = "teComponentInventory.colorRows";
export const COLUMN_VISIBILITY_STORAGE_KEY = "teComponentInventory.columnVisibility";
