...
mod tests {
    ...
    fn preview_cache_rejects_invalid_or_missing_paths() {
        let cache_dir = temp_test_dir("te-component-inventory-preview-cache-invalid");
    ...
    fn preview_cache_copies_valid_image() {
        let path = std::env::temp_dir().join(format!(
            "te-component-inventory-preview-{}.png",
            uuid::Uuid::new_v4().simple()
        ));
        let cache_dir = temp_test_dir("te-component-inventory-preview-cache-valid");
    ...
    fn preview_cache_allows_common_camera_sized_images() {
        let path = std::env::temp_dir().join(format!(
            "te-component-inventory-preview-camera-{}.jpg",
            uuid::Uuid::new_v4().simple()
        ));
        let cache_dir = temp_test_dir("te-component-inventory-preview-cache-camera");
    ...
    fn preview_cache_rejects_non_image_content_with_supported_extension() {
        let path = std::env::temp_dir().join(format!(
            "te-component-inventory-preview-not-image-{}.png",
            uuid::Uuid::new_v4().simple()
        ));
        let cache_dir = temp_test_dir("te-component-inventory-preview-cache-not-image");
    ...
    fn preview_cache_rejects_oversized_images() {
        let path = std::env::temp_dir().join(format!(
            "te-component-inventory-preview-large-{}.png",
            uuid::Uuid::new_v4().simple()
        ));
        let cache_dir = temp_test_dir("te-component-inventory-preview-cache-large");
